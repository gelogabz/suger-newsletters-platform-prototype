const topics = [
    ...
    hyperscalers: [
      {
        ...
        source: { label: "Amazon Bedrock Multi-Agent Docs", url: "https://docs.aws.amazon.com/bedrock/latest/userguide/agents.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure AI Foundry Documentation", url: "https://learn.microsoft.com/en-us/azure/ai-studio/" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Next 2025 — Agent Space Announcement", url: "https://cloud.google.com/blog/products/ai-machine-learning/google-cloud-next-2025-announcements" }
      }
    ],
    implications: "The hyperscaler agent layer is where platform stickiness is being built right now. Enterprise buyers evaluating AI strategies are implicitly making a platform commitment — AWS Bedrock agents, Azure Copilot, or GCP Agent Space each create different integration dependencies over time. For marketplace sellers, this is the window to position your product as agent-compatible or agent-powered on whichever cloud your customers run. Being listed and certified in the right marketplace as agent ecosystems mature will compound in value over the next 12–18 months."
  },

  {
    id: "concurrent-agreements",
    title: "Concurrent Agreements",
    subtitle: "Marketplace Deal Mechanics Are Catching Up to Enterprise Reality",
    tags: ["aws", "azure", "gcp"],
    intro: "Private offers and custom deal structures across AWS, Azure, and GCP have matured significantly. The underlying mechanics — who can negotiate with whom, how agreements stack, and how resellers fit in — now determine how fast complex enterprise deals close on-marketplace versus falling off it entirely.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Marketplace Private Offers", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/private-offers-overview.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Marketplace Multiparty Private Offers", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/multiparty-private-offers-for-isv" }
      },
      {
        tagId: "gcp",
...

  {
    ...
    tags: ["aws", "azure", "gcp"],
    intro: "The model wars have been fought in the open. The infrastructure war is quieter, but its outcome will determine who wins on cost, latency, and scale over the next three years. All three hyperscalers are now building or deploying custom silicon — and the differences matter more than most sellers and buyers realize.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Trainium and Inferentia Overview", url: "https://aws.amazon.com/machine-learning/trainium/" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure AI Infrastructure Overview", url: "https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/overview" }
      },
      {
        tagId: "gcp",
...

  {
    ...
    tags: ["gcp", "aws", "azure"],
    intro: "Google Cloud Next 2025 (April 9–11, Las Vegas) was the most ISV-relevant Google event in years. Beyond the model announcements, the practical marketplace and distribution changes are what matter for sellers and partners operating across all three clouds.",
    hyperscalers: [
      {
        tagId: "gcp",
        headline: "Agent Space, Ironwood, and a New Marketplace Distribution Play",
        ...
        source: { label: "Google Cloud Next 2025 Announcements", url: "https://cloud.google.com/blog/topics/google-cloud-next" }
      },
      {
        tagId: "aws",
        ...
        source: { label: "Amazon Bedrock Overview", url: "https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html" }
      },
      {
        tagId: "azure",
        headline: "Microsoft Previews Build 2025, Reinforces AI Foundry Messaging",
        ...
        source: { label: "Microsoft Partner Center — AI Solutions", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/" }
      }
    ],
    implications: "Google Cloud Next set a competitive tone that rippled across all three hyperscalers for the rest of Q2. For ISVs, the key takeaway isn't which announcements were flashiest — it's that GCP's enterprise AI infrastructure is now credible enough to compete for workloads that would have defaulted to AWS or Azure 18 months ago. If your product isn't listed on GCP Marketplace, the addressable opportunity you're missing is growing."
  },

  {
    ...
    tags: ["aws", "azure", "gcp"],
    intro: "Co-selling with a hyperscaler is not the same thing as listing on their marketplace. Understanding the mechanics of each program — who qualifies, what the seller gets, and how referrals flow — is the difference between a theoretical partnership and a real revenue channel.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Partner Central — ACE Program", url: "https://docs.aws.amazon.com/partner-central/latest/builder-guide/index.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure IP Co-sell Requirements", url: "https://learn.microsoft.com/en-us/partner-center/co-sell-overview" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Partner Advantage Program", url: "https://cloud.google.com/partners/partnersearch/partner-advantage" }
      }
    ],
    implications: "Co-sell programs are not passive — they require active pipeline submission, relationship management, and consistent Marketplace transaction volume to unlock their full value. The ISVs seeing the best returns treat ACE, IP Co-sell, and Partner Advantage as sales channels with dedicated owners, not as checkboxes on a partnership agreement. If your co-sell motion is managed by someone for whom it's a 20% responsibility, you're leaving significant pipeline on the table."
  },

  {
    ...
    intro: "Snowflake Marketplace has quietly become a significant distribution channel for ISVs whose products run on or interact with Snowflake data. The Native App Framework changes what's possible — and the cross-listing strategy with AWS and GCP is where the real opportunity lies.",
    hyperscalers: [
      {
        tagId: "snowflake",
        ...
        source: { label: "Snowflake Native App Framework Docs", url: "https://docs.snowflake.com/en/developer-guide/native-apps/native-apps-about" }
      },
      {
        tagId: "aws",
        ...
        source: { label: "AWS Marketplace + Snowflake Integration", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/listing-on-marketplace.html" }
      },
      {
        tagId: "gcp",
    ...
    hyperscalers: [
      {
        ...
        source: { label: "AWS Marketplace CPPO Documentation", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/channel-partner-private-offers.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Multiparty Private Offers for ISVs", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/multiparty-private-offers-for-isv" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "GCP Marketplace Channel Private Offers", url: "https://cloud.google.com/marketplace/docs/partners/integrated-saas/create-channel-private-offer" }
      }
    ],
    implications: "Private offer mechanics are the plumbing that determines whether your channel motion scales. ISVs with reseller programs who haven't formalized CPPO/MPO/MCPO workflows are creating manual work for every channel deal — and leaving the audit trail that hyperscalers use to track co-sell attribution on the floor. The investment to set up these workflows pays back on the first deal it enables."
  },

  {
    ...
    tags: ["aws", "azure", "gcp"],
    intro: "Every major hyperscaler runs programs that fund ISV adoption activities — migrations, proof-of-concepts, and partner-driven deals. The funding is real, but eligibility requirements, timelines, and amounts vary. Here's what's actually available and how to access it.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Migration Acceleration Program", url: "https://aws.amazon.com/migration-acceleration-program/" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Migration and Modernization Program", url: "https://learn.microsoft.com/en-us/partner-center/partner-earned-credit-overview" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Partner Advantage", url: "https://cloud.google.com/partners/partnersearch/partner-advantage" }
      }
    ],
    implications: "Hyperscaler funding programs are underutilized by most ISVs — not because they're inaccessible, but because the application process requires documentation that most partnership teams don't have ready. The ISVs who consistently access funding have a standing deal template, a documented POC scope, and a partner development manager relationship they can activate quickly. If your team is doing POCs without checking whether hyperscaler funding is available, you're absorbing costs you shouldn't be."
  },

  {
    id: "byol-vs-saas",
    title: "BYOL vs. SaaS Listings",
    subtitle: "Choosing the right model — and why it changes your co-sell eligibility",
    tags: ["aws", "azure", "gcp"],
    intro: "Choosing between Bring Your Own License (BYOL) and SaaS pricing on cloud marketplaces isn't just a technical decision — it determines your billing model, your customer's purchasing experience, and critically, how much marketplace revenue gets attributed to your ARR and co-sell standing.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Marketplace Listing Types", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/listing-on-marketplace.html" }
      },
      {
        tagId: "azure",
        headline: "Azure: Contact Me, Free Trial, and Transact — Three Different Bets",
        ...
        source: { label: "Azure Marketplace Offer Types", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/publisher-guide-by-offer-type" }
      },
      {
        tagId: "gcp",
...

  {
    ...
    title: "AI on the Marketplace: Models, Agents, and What Buyers Actually Buy",
    subtitle: "How AI products are listed, discovered, and billed across hyperscalers",
    tags: ["aws", "azure", "gcp"],
    intro: "AI models are now first-class marketplace products. All three hyperscalers have model hubs, and the mechanics of how models are listed, discovered, and billed differ in ways that matter for AI-native ISVs and for buyers trying to manage costs at scale.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "Amazon Bedrock and SageMaker Marketplace", url: "https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure AI Foundry Model Catalog", url: "https://learn.microsoft.com/en-us/azure/ai-studio/how-to/model-catalog-overview" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Model Garden", url: "https://cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models" }
      }
    ],
    implications: "AI listings are the fastest-growing category on every major cloud marketplace. For ISVs with AI-native products, this creates a timing advantage: buyers are actively browsing for AI tooling they haven't bought before, and the marketplace is where enterprise procurement is increasingly directing that spend. The window to establish a strong listing before the category matures is narrowing — Q1 and Q2 of 2026 are the right time to move."
  },
    ...
    hyperscalers: [
      {
        ...
        source: { label: "AWS Partner Foundational Technical Review", url: "https://docs.aws.amazon.com/partner-central/latest/builder-guide/foundational-technical-review.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Marketplace Security Requirements", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/certification-policies" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Ready Program", url: "https://cloud.google.com/partners/resources/google-cloud-ready" }
      }
    ],
    implications: "Certification is no longer just about compliance — it's about search visibility. All three hyperscalers now use certification status as a ranking signal in marketplace discovery. Uncertified listings rank lower, appear in fewer curated collections, and don't qualify for co-sell programs that require validated status. If your listing hasn't been through FTR, publisher attestation, or GCR in the past 12 months, schedule it now — the opportunity cost of delay compounds every quarter."
  },

  {
    ...
    intro: "Data products — datasets, analytics tables, ML training sets, and enrichment feeds — are an increasingly significant category on cloud marketplaces. The model is different from software listings, the economics are different, and the buyer motion is different. Here's how the three primary channels compare.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Data Exchange Documentation", url: "https://docs.aws.amazon.com/data-exchange/latest/userguide/what-is-data-exchange.html" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "GCP Analytics Hub Overview", url: "https://cloud.google.com/bigquery/docs/analytics-hub-introduction" }
      },
      {
        tagId: "snowflake",
...

  {
    ...
    tags: ["aws", "azure", "gcp"],
    intro: "2025 was the year cloud marketplaces crossed from a useful distribution channel to the primary sales motion for enterprise software. The committed spend programs, co-sell sophistication, and enterprise buyer preference for on-marketplace transactions all moved in the same direction — and the ISVs who were ready captured disproportionate growth.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Marketplace for Sellers", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/what-is-marketplace.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Consumption Commitments for ISVs", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/azure-consumption-commitment-benefit" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "GCP Marketplace Committed Use", url: "https://cloud.google.com/marketplace/docs/partners/integrated-saas/listing-saas" }
      }
    ],
    implications: "The 2025 story for cloud marketplaces is straightforward: committed spend programs created a structural buyer incentive to purchase on-marketplace that didn't fully exist in 2023. ISVs who are MACC-eligible, EDP-attributed, and GCCP-qualified are operating with a tailwind that their non-marketplace competitors don't have. If your 2026 planning doesn't include a specific plan to achieve or expand these designations, you're ceding ground to competitors who do."
  },

  {
    ...
    tags: ["aws", "azure", "gcp"],
    intro: "All three hyperscalers restructured or significantly updated their partner programs in 2025. For ISVs navigating these changes, the key question is what actually changed for your program status — and what you need to do before your next renewal.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS ISV Accelerate Program", url: "https://aws.amazon.com/partners/programs/isv-accelerate/" }
      },
      {
        tagId: "azure",
        headline: "Microsoft AI Cloud Partner Program: AI Competencies Now Central",
        ...
        source: { label: "Microsoft AI Cloud Partner Program", url: "https://learn.microsoft.com/en-us/partner-center/intro-to-cloud-partner-program-membership" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Partner Specializations", url: "https://cloud.google.com/partners/partnersearch/partner-advantage" }
      }
    ],
    implications: "The partner program restructures across all three hyperscalers in 2025 sent a consistent signal: AI-oriented ISVs are being prioritized for co-sell resources, go-to-market funding, and marketplace visibility. If your product has a credible AI story — even as an adjacent capability — getting the relevant AI designation is now worth the effort. The ISVs without it will find themselves increasingly outprioritized by competitors who have it, regardless of deal quality."
  },

  {
    id: "marketplace-outlook-2026",
    title: "What to Watch in 2026",
    subtitle: "Where cloud marketplace growth is going — and what ISVs should do now",
    tags: ["aws", "azure", "gcp"],
    intro: "The structural tailwinds behind cloud marketplace growth are not slowing in 2026. Committed spend programs, co-sell sophistication, and enterprise buyer preference for on-marketplace transactions are all accelerating. Here's where the opportunity concentrates — and what ISVs should do in the next two quarters.",
    hyperscalers: [
      {
        tagId: "aws",
        ...
        source: { label: "AWS Marketplace for Buyers and Sellers", url: "https://docs.aws.amazon.com/marketplace/latest/userguide/what-is-marketplace.html" }
      },
      {
        tagId: "azure",
        ...
        source: { label: "Azure Marketplace Go-To-Market Resources", url: "https://learn.microsoft.com/en-us/partner-center/marketplace/gtm-your-marketplace-benefits" }
      },
      {
        tagId: "gcp",
        ...
        source: { label: "Google Cloud Marketplace for Partners", url: "https://cloud.google.com/marketplace/docs/partners" }
      }
    ],
    implications: "2026 is a pivotal year for ISVs who've been watching cloud marketplaces from the sidelines. The committed spend programs have created buyer incentive; the co-sell programs have matured enough to generate real pipeline; and the certification requirements are clear enough that the path to listing is predictable. The window to get listed, certified, and co-sell-active before the category is fully competitive is 2026. The question isn't whether to invest — it's whether you move in Q1 or spend the year watching competitors who did."
  }
